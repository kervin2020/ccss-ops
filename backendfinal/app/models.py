...
class User(db.Model):
    ...
    # admin, manager, supervisor, hr, finance
...
class Attendance(db.Model):
    ...
    corrections = db.relationship(
        'Correction', backref='attendance', lazy=True)
...
class Correction(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    attendance_id = db.Column(db.Integer, db.ForeignKey(
        'attendances.id'), nullable=False)
    agent_id = db.Column(db.Integer, db.ForeignKey(
        'agents.id'), nullable=False)
